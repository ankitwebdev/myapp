...
<?php include 'header.php';  ?>
    ...
    padding: 5px;
    margin: auto;
    background-image: url('images/fb5in.jpg');
...
.random>p
{
  ...
  <?php include 'nav.php' ?>
       ...
       <?php if(isset($_SESSION['FBID'])):  
        $id= $_SESSION['FBID'];
        // $resultid= "results/"."rgrgrg02"."$id".".png";
        $imageid="user/dog"."$id"."."."png";
...
return $randomImage;
              ...
              $the_image = RandImg('images/dogs/');


// echo $the_image;
 ?>
 <img class="img-responsive" src="<?php echo $the_image; ?>" id="rg" width="200px" style="margin-left: argin-left: 33%;
    float: left;
    width: 40%;
    height: 166px;
    margin: 69px 42px;
        ...
        <div class="row">
          <div class="col-lg-8">            
            <div class="app">
              ...
              <br>
              <img class="img-responsive" src="images/fb5in.jpg"" alt="">           
                                  <br>
                          
                      <div class="btn-group">
                              <a href="fbconfigdog.php"> 
