...
?>
    ...
    padding: 5px;
    margin: 5px;
    background-image: url('dating/images/datingresult.png');
    ...
    <script> 
      ...
      function postToFeed() {
        ...
        var obj = {
          ...
          method: 'feed',
          redirect_uri: 'https://appsfun.xyz/datingresult.php',
          link: 'https://appsfun.xyz/dating.php',
          picture: 'https://appsfun.xyz/<?php echo $resultid; ?>',
          name: 'Who will you date next month?',
          caption: 'appsfun.xyz',
...
<?php echo '<img class="img-responsive center-block" 
 src="'."http://appsfun.xyz/".$resultid.'" />'; ?>
     ...
     <p class="text">
            this is the letter your true love name starts from! Happiness awaits you exactly where you wouldn't have expected it and that is the reason why you will find love when you're not looking for it! The most beautiful time of your life is right around the corner because your soulmate is already waiting for you!
Share your place of true love and show everyone where your happiness actually waits for you!</p>
