...
if (isset($accessToken)) {
	...
	if (isset($_GET['code'])) {
		header('Location: https://appsfun.xyz/freedomfbconfig.php');
	}
...
header("Location:  https://appsfun.xyz/freedom.php"); /* Redirect browser */
exit();
	...
	$loginUrl = $helper->getLoginUrl('https://appsfun.xyz/freedomfbconfig.php', $permissions);
