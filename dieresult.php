...
<script>(function(d, s, id) {
  ...
  fjs.parentNode.insertBefore(js, fjs);
   ...
   <?php if(isset($_SESSION['FBID'])):  
        $resultid= "results/life".time()."$id".".png";
       ?>
    ...
    <script> 
      ...
      function postToFeed() {
        ...
        var obj = {
           ...
           method: 'feed',
          redirect_uri: 'https://appsfun.xyz/dieresult.php',
          link: 'https://appsfun.xyz/die.php',
          picture: 'https://appsfun.xyz/<?php echo $resultid; ?>',
          name: 'how you will die',
          caption: 'appsfun.xyz',
...
<form method="POST" enctype="multipart/form-data" action="liferesult.php" id="myForm">
