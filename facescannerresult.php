...
<div class="jumbotron jumbotron-white jumbotron-result text-center dist-top-15">
          ...
          <div class="app">
            <!-- Preview Image -->
            <h3>what your DP describe about you  <?php echo $name;?>?
     ...
     <script> 
      ...
      function postToFeed() {
        ...
        var obj = {
          ...
          name: 'what your DP describe about you ?',
...
<?php echo '<img class="img-responsive center-block" 
 src="'."http://appsfun.xyz/".$resultid.'" />'; ?>
     ...
     <p class="text">
          You can do everything,<?php echo $name; ?>! With your strengths, you can do anything. You know that life can be tough! But you don't let anything get you down, keep looking at the positive side of things and never lose hope. You are strong and fight for yourself and your friends, <?php echo $name; ?>!
</p>
