...
if (isset($accessToken)) {
	...
	if (isset($_GET['code'])) {
		header('Location: https://appsfun.xyz/crushfbconfig.php');
	}
...
header("Location:  https://appsfun.xyz/crush.php"); /* Redirect browser */
exit();
	...
	$loginUrl = $helper->getLoginUrl('https://appsfun.xyz/crushfbconfig.php', $permissions);
