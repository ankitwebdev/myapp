    ...
    <script> 
      ...
      function postToFeed() {
        ...
        var obj = {
          ...
          method: 'feed',
          redirect_uri: 'https://appsfun.xyz/crushresult.php',
          link: 'https://appsfun.xyz/dating.php',
          picture: 'https://appsfun.xyz/<?php echo $resultid; ?>',
          name: 'How Many People Have Crush On You?',
          caption: 'appsfun.xyz',
...
<?php echo '<img class="img-responsive center-block" 
 src="'."http://appsfun.xyz/".$resultid.'" />'; ?>
     ...
     <p class="text">
           You have made so many heads turn! People can't stop looking at or thinking of you! Who could resist your incredible beauty and your sense of humor? You make  person's knees weak! Share your result and show your friends how many people have a crush on you!</p>
