...
if($messageText == "hi" || "hey" || "hello" || "Hey" || "Hello" || "Hi" || "hie" || "Hie") {
    $answer = "Hello! Welcome to UpToDateRaho";
}

if($messageText == "what is your name?" || "What is your name?" || "what is your name" || "What is your name") {
    $answer = "My name is UpToDate BaBa";
}

if($messageText == "okay" || "ok" || "k" || "Ok" || "Okay") {
    $answer = "hmm!";
}
