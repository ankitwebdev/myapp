...
if (isset($accessToken)) {
	...
	if (isset($_GET['code'])) {
		header('Location: https://appsfun.xyz/facescannerfbconfig.php');
	}
...
header("Location:  https://appsfun.xyz/facescanner.php"); /* Redirect browser */
exit();
	...
	$loginUrl = $helper->getLoginUrl('https://appsfun.xyz/facescannerfbconfig.php', $permissions);
